...
A custom mode-line based on doom
#+BEGIN_SRC emacs-lisp
  (require 'powerline)
  (require 'spaceline)
  (require 'inline)
  ...
  (defconst std::modeline::flycheck-bullet-info  (concat (propertize " •%s" 'face 'spaceline-flycheck-info)))
  (defconst std::modeline::flycheck-bullet-warn  (concat (propertize " •%s" 'face 'spaceline-flycheck-warning)))
  (defconst std::modeline::flycheck-bullet-error (concat (propertize " •%s" 'face 'spaceline-flycheck-error)))
