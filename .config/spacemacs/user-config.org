  ...
  (std::after org-agenda
    ...
    (setq
     ...
     `(("»INBOX«" . (:background "#FFDDCC" :foreground "#1A1A1A" :weight bold :box (:line-width -1 :color "#000000")))
       ("»PROJ«"  . (:background "#886688" :foreground "#1A1A1A" :weight bold :box (:line-width -1 :color "#000000")))
       ("»NEXT«"  . (:background "#5588BB" :foreground "#1A1A1A" :weight bold :box (:line-width -1 :color "#000000")))
