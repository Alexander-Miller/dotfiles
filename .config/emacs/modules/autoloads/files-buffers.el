...
(defun std::buffers::edit-misc-cfg ()
  ...
  (let* ((alist
          '(("git"           . "~/.config/git/config")
            ...
            ("waybar cfg"    . "~/.config/waybar/config.jsonc")
            ("waybar css"    . "~/.config/waybar/style.css")
            ("mpd"           . "~/.config/mpd/mpd.conf")
            ("mpv"           . "~/.config/mpv/mpv.conf")
            ("mpv keys"      . "~/.config/mpv/input.conf")
            ("ncmpcpp cfg"   . "~/.config/ncmpcpp/config")
            ("ncmpcpp keys"  . "~/.config/ncmpcpp/bindings")
            ("paru"          . "~/.config/paru/paru.conf")
            ("rofi"          . "~/.config/rofi/config.rasi")
            ("tridactyl cfg" . "~/.config/tridactyl/tridactylrc")
            ("tridactyl css" . "~/.config/tridactyl/themes/MorningStar.css")
